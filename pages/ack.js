  ...
  return (
    <>
      ...
      <ul className="ml-4 sm:ml-8 list-disc">
        ...
        <li className="p-4">
          Theme & styling with{' '}
          <a className="link" href="https://tailwindcss.com/" title="tailwindcss">
            tailwindcss
          </a>
        </li>
        <li className="p-4">
        ...
        <li className="p-4">
          Deployment with{' '}
          <a className="link" href="https://vercel.com/" title="Vercel">
            Vercel
          </a>
        </li>
        <li className="p-4">
          Wallpaper <i>Ash Rain</i> created by{' '}
          <a className="link" href="https://www.deviantart.com/ellysiumn" title="Ellysiumn">
            Ellysiumn
          </a>
        </li>
        <li className="p-4">
      ...
      <h2 className="my-4 text-2xl font-bold">Legal Information</h2>
      <Collapse defaultActiveKey={['1']}>
        <Panel header="COPYRIGHT DISCLAIMER" key="copyright">
          <article className="prose-sm">
            ...
            <p>
              The information provided by Jerry Jia (“we,” “us” or “our”) on{' '}
              <a href="http://www.jerrykjia.com">http://www.jerrykjia.com</a> (the “Site”) and our
              mobile application is for general informational purposes only. All information on the
              Site and our mobile application is provided in good faith, however we make no
              ...
              the Site or our mobile application. UNDER NO CIRCUMSTANCE SHALL WE HAVE ANY LIABILITY
              TO YOU FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT OF THE USE OF THE SITE
              OR OUR MOBILE APPLICATION OR RELIANCE ON ANY INFORMATION PROVIDED ON THE SITE AND OUR
              MOBILE APPLICATION. YOUR USE OF THE SITE AND OUR MOBILE APPLICATION AND YOUR RELIANCE
              ON ANY INFORMATION ON THE SITE AND OUR MOBILE APPLICATION IS SOLELY AT YOUR OWN RISK.
            </p>
            <p>
            ...
            <p>
              ...
              or our mobile application) links to other websites or content belonging to or
              ...
              NOT WARRANT, ENDORSE, GUARANTEE, OR ASSUME RESPONSIBILITY FOR THE ACCURACY OR
            ...
            <p>
              The Site cannot and does not contain web development advice. The web development
              ...
              We do not provide any kind of web development advice. THE USE OR RELIANCE OF ANY
              INFORMATION CONTAINED ON THIS SITE OR OUR MOBILE APPLICATION IS SOLELY AT YOUR OWN
              RISK.
            </p>
          </article>
        </Panel>
        <Panel header="TERMS OF USE" key="term">
          <article className="prose-sm">
            ...
            <p>
              ...
              personally or on behalf of an entity (“you”) and jerrykjia.com (&quot;
              <strong>Company</strong>&quot;, “<strong>we</strong>”, “<strong>us</strong>”, or “
              <strong>our</strong>”), concerning your access to and use of the{' '}
              <code>jerrykjia.com</code> website as well as any other media form, media channel,
            ...
            <p>
              (2) you are not a minor in the jurisdiction in which you reside; (3) you will not
              access the Site through automated or non-human means, whether through a bot, script,
              or otherwise; (4) you will not use the Site for any illegal or unauthorized purpose;
            ...
            <p>
              ...
              trade secret, or moral rights of any third party. 2. You are the creator and owner of
              or have the necessary licenses, rights, consents, releases, and permissions to use and
              to authorize us, the Site, and other users of the Site to use your Contributions in
              any manner contemplated by the Site and these Terms of Use. 3. You have the written
              ...
              inaccurate, or misleading. 5. Your Contributions are not unsolicited or unauthorized
              advertising, promotional materials, pyramid schemes, chain letters, spam, mass
              mailings, or other forms of solicitation. 6. Your Contributions are not obscene, lewd,
              ...
              disparage, intimidate, or abuse anyone. 8. Your Contributions are not used to harass
              or threaten (in the legal sense of those terms) any other person and to promote
              violence against a specific person or class of people. 9. Your Contributions do not
              violate any applicable law, regulation, or rule. 10. Your Contributions do not violate
              the privacy or publicity rights of any third party. 11. Your Contributions do not
              ...
              otherwise intended to protect the health or well-being of minors. 13. Your
              Contributions do not include any offensive comments that are connected to race,
              national origin, gender, sexual preference, or physical handicap. 14. Your
            ...
            <p>
              These Terms shall be governed by and defined the laws of People&#39;s Republic of
              China.
            </p>
            <p>
              Yourself irrevocably consent that the courts of People&#39;s Republic of China shall
            ...
            <p>
              ...
              clause. The number of arbitrators shall be 1. The seat, or legal place, of arbitration
              shall be 1. The language of the proceedings shall be Chinese. The governing law of the
              contract shall be the substantive law of People&#39;s Republic of China.
            </p>
            <p>
            ...
            <p>
              ...
              concerning the validity of, any of the intellectual property rights of a Party; (b)
              any Dispute related to, or arising from, allegations of theft, piracy, invasion of
